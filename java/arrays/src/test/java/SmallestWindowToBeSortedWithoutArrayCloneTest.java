...
class SmallestWindowToBeSortedWithoutArrayCloneTest {

    SmallestWindowToBeSortedWithoutArrayClone smallestWindowToBeSorted = new SmallestWindowToBeSortedWithoutArrayClone();
